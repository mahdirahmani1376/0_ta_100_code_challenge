    ...
    */
    ...
    'connections' => [
        ...
        'mainapp' => [
            ...
            'database'       => env('DB_MAINAPP_DATABASE'),
            'username'       => env('DB_MAINAPP_USERNAME'),
            'password'       => env('DB_MAINAPP_PASSWORD'),
            'unix_socket'    => env('DB_SOCKET', ''),
            'charset'        => 'utf8mb4',
            'collation'      => 'utf8mb4_unicode_ci',
            'prefix'         => '',
        ...
        'whmcs' => [
            ...
            'database'       => env('DB_WHMCS_DATABASE'),
            'username'       => env('DB_WHMCS_USERNAME'),
            'password'       => env('DB_WHMCS_PASSWORD'),
            'unix_socket'    => env('DB_SOCKET', ''),
            'charset'        => 'latin1',
