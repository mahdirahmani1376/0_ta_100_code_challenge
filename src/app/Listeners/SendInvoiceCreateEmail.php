...
class SendInvoiceCreateEmail implements ShouldQueue
{
    public function handle(InvoiceCreated $event): void
    {
        try {
            ...
            $client = MainAppAPIService::getClients($event->invoice->profile->client_id)[0];
            ...
            MainAppAPIService::sendInvoiceCreateEmail($event->invoice->profile->client_id, $subject, $message);
